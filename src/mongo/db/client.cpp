    ...
    */
    ...
    void Client::Context::_finishInit( bool doauth ) {
        ...
        if ( writeLocked && FileAllocator::get()->hasFailed() ) {
            uassert(14031, "Unable to write, you've reached your allocated quota.  Please visit https://app.objectrocket.com or contact support@objectrocket.com for assistance.", false);
        }
